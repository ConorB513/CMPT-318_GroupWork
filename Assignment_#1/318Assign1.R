...
print(numOutliersGrp);
print(length(grpZScores));
...
print((numOutliersGrp/length(gapZScores)) * 100);
print(numOutliersGrp);
print(length(gapZScores));


allVolt <- one_week_data1[,c("Voltage")];
voltZScores <- (allVolt - mean(allVolt)) / sd(allVolt);
numOutliersVolt <- length(voltZScores[abs(voltZScores) > 3]);
print((numOutliersVolt/length(voltZScores)) * 100);
print(numOutliersVolt);
print(length(voltZScores));
...
print(numOutliersSM1);
print(length(sm1ZScores));
...
print(numOutliersSM2);
print(length(sm2ZScores));
...
print(numOutliersSM3);
print(length(sm3ZScores))
